...
@Component({
  selector: 'app-crear-bitacoras',
  templateUrl: './crear-bitacoras.component.html',
  styleUrls: []
})
export class CrearBitacorasComponent implements OnInit {

  title: string = "Nueva Bitácora";
      ...
      .crearBitacoras(
        ...
        .subscribe((res: any) => {                       
          if (res.ok == true) {  
            ...
            Swal.fire({    
              text: 'Bitácora creada correctamente',
              icon: 'success',
              confirmButtonText: 'OK',
              allowOutsideClick: false
            }).then((result) => {
              this.loadingButton = false;
              this.router.navigate(['/listarbitacoras']);
            });                  
          } else {
            this.error();
          }         
